const fs = require('fs');
let content = fs.readFileSync('artifacts/study-tracker/src/features/dashboard/SubjectsGrid.tsx', 'utf-8');

const newGrid = `import React from 'react';
...
fs.writeFileSync('artifacts/study-tracker/src/features/dashboard/SubjectsGrid.tsx', newGrid);
