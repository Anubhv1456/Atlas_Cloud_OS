...
for (let line of lines) {
  ...
  if (line.match(/^\d+\./)) {
    ...
    // There are some lines which are not starting with "    - " but represent topics under the system.
    // Wait, the input above had "    - ", but wait! The user provided this format:
    // • General Anatomy
    // Introduction to Anatomy
    // Anatomical Terminology
    // Let me check my javascript logic.
  }
}
