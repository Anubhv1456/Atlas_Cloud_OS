    ...
    content: (
      <div className="space-y-8">
        ...
        <section className="space-y-2">
          ...
          <p className="text-sm text-muted-foreground leading-relaxed">
            Curriculum sets can be configured with distinct study depths: <strong>Rapid Drill (~15m)</strong>, <strong>Standard (~30m)</strong>, or <strong>Deep Block (~60m)</strong>. The Knapsack Adaptive Optimization Engine automatically factors depth into your daily schedule.
          </p>
        </section>
      </div>
    )
