          ...
          <div>
            <div className="grid grid-cols-7 gap-1.5 sm:gap-2 mb-2 text-center">
              {['Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat', 'Sun'].map(d => (
                <div key={d} className="text-[11px] font-bold uppercase tracking-wider text-muted-foreground/80 py-1">
                  {d}
                </div>
              ))}
            </div>
            ...
            <div className="flex items-center justify-between text-xs font-mono text-muted-foreground pt-3.5 border-t border-border/40 mt-4 px-1">
              ...
              <div className="text-[10px] sm:text-[11px] uppercase tracking-wider font-semibold text-muted-foreground/70 hidden xs:inline">
                Dual-Signal Radar
              </div>
            </div>
          </div>
